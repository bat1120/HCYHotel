...
function popCalendarLayer(dateId , today){
	...
	if(today != '2023-12-14'){
		today = today.split("-");
		var originToday = "2023-12-14".split("-");
...
<link href="http://192.168.10.147/HCYHotel/common/user/css/shilla/title_ko.css" rel="stylesheet" type="text/css">
<link href="http://192.168.10.147/HCYHotel/common/user/css/shilla/print.css" rel="stylesheet" type="text/css" media="print">
<link href="http://192.168.10.147/HCYHotel/common/user/css/shilla/mainImages.css" rel="stylesheet" type="text/css">
<link href="http://192.168.10.147/HCYHotel/common/user/css/shilla/reserve_new.css" rel="stylesheet" type="text/css">
<link href="http://192.168.10.147/HCYHotel/common/user/css/shilla/lang-ko_N.css" rel="stylesheet" type="text/css">
<link href="http://192.168.10.147/HCYHotel/common/user/css/shilla/btn.css" rel="stylesheet" type="text/css">
<link href="http://192.168.10.147/HCYHotel/common/user/css/shilla/swiper.min.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="/js/jquery.ad-gallery.js?dt=2023-12"></script>
...
// 신라리워즈>회원전용프로모션>객실패키지>신라스테이탭>예약하기 클릭해서 넘어올때	 호텔명 미노출,확인버튼disable 수정요청 ~> 스테이 허브처럼 호텔정보를 가지고 이동해야 한다고 가이드 했으나,현재상태로 진행 요청
...
// 								}
		...
		if(ckinYmd == "" && ckoutYmd == ""){
			...
			var ckinD =  getKrTime("2023-12-14");
			...
			var ckoutD =  getKrTime("2023-12-14");
				...
				success : function(json){
					...
					for(var c = 0;c < hotlList.length; c++){
						...
						if(hotlObj.resvPosbAheadDyCnt != "0"){
							aheadDayYnTF = fnResvPosbAheadDyYnTF(hotlObj.resvPosbAheadDyCnt, '2023-12-14');
							if(!aheadDayYnTF){
								switch (lang) {
									...
									success : function(data){
										...
										if(targetTab == "tabMbr"){
											...
											roomtab = true;
		     								...
		     								/** 포브스 지적사항 Room탭의 객실이 먼저 노출되도록 ~> Room 데이터가 없어도 Room 탭 우선 */
											if("ko" == "ko"){
												if(mbrPackCnt > 0){
													mbrtab = true;
												}
	...
	setRoom = function(roomIdx, bedSeq, mappingCnt, resvTypCd, roomCd, viewCd, roomTypCd, bedTypCd, ratePlanCode, spofrId, packItNo, roomClsCd, infantResvYn, viewNm, resvTyp ) {
		...
		for(var x = 0; x < parseInt(roomCnt);x++){
			...
			// 전망/침대타입 앞 라디오 버튼 클릭시 alert 노출 로직
			if(alertFlag){
				// 신라스테이이면서, 총이용인원수가 4명일때, 5명일때, 3명일때
	...
	function checkR(spofrId, holtId) {
		//var url = "/"+"seoul"+"/resv/rpm/memSetStep1.do?spofrId="+spofrId+"&propertyId=S";
		var url = "/seoul/resv/rpm/memSetStep1.do?spofrId=" + spofrId +"&propertyId="+holtId+"&lang=ko";
...
<input type="hidden" id="srvTime" name="srvTime" value="2023-11-14-15" autocomplete="off">
	...
	<div class="rsvWrap">
			<div class="rsvSchHotel">
          		<div class="rsvSchCont htSch">
          			<dl>
          				...
          				<dd class="htSchWrap">
							<input type="text" placeholder="호텔을 선택해주세요." class="inpHtSch text" id="searchBarKeyword" title="호텔 선택" autocomplete="off">
          		...
          		<div class="rsvSchCont htCheck">
          			<dl>
          				...
          				<dd><a href="#none" class="btnCalShow" id="ckinDateInfo">2023.12.14 (목)</a></dd>
          				<input type="hidden" name="ckinYmd" id="ckinYmd" title="체크인 날짜 입력" value="2023-12-14" autocomplete="off">
          			</dl>
          			<dl class="stay">
          			...
          			<dl>
          				...
          				<dd><a href="#none" class="btnCalShow" id="ckoutDateInfo">2023.12.15 (금)</a></dd>
          				<input type="hidden" name="ckoutYmd" id="ckoutYmd" title="체크아웃 날짜 입력" value="2023-12-15" autocomplete="off">
          			</dl>
          		</div>
          		<div class="rsvSchCont htRoom">
          			...
          			<dl>
          				<dt>
          					...
          					<span class="btnQuestion">
          						...
          						<span class="warnBalloonBox" style="width:250px;">37개월 이상 ~ 만 12세 이하 (베트남 : 만 6세 이상 ∼ 만 11세까지)</span>
          					</span>
          				</dt>
          			...
          			<dl>
          				<dt>
          					...
          					<span class="btnQuestion">
          						<strong class="hidden">안내</strong>
          						<span class="warnBalloonBox">36개월 이하 (베트남 : 만 5세 이하)</span>
          					</span>
          				</dt>
          		...
          		<div class="rsvSchCont btnSearch">
		            ...
		            <div class="ly_reserve htSearch">
	              	...
	              	<div class="htBox" style="display:block">
														...
														<dd>
															<ul>
																<li data-hotlid="C" data-hoteltitle="제주신라호텔" data-addr="제주특별자치도 서귀포시 색달동 중문관광로72번길 75<br>(우 : 63535)" data-imgurl="https://www.shilla.net//images/upload/spofrpack/191125/FILE2ebee8d30d2367.jpg" class="first">
																	...
																	<li data-hotlid="YESSS" data-hoteltitle="신라스테이 여수" data-addr="전라남도 여수시 수정3길 8" data-imgurl="https://www.shilla.net//images/upload/spofrpack/230104/FILEb0dc32e44dcae49e.jpg" class="first">
																			<a href="#none" class="">신라스테이 여수</a>
																		</li>
						...
						<div class="btnList">
			    			<a href="#none" class="btnSubmit" id=""><img src="/images/ko/mem/new_2019/reserve_step1_ok.gif" alt="확인" id="keywordAreaBtn"></a>
	           			</div>
		            </div>
					...
					<div class="ly_reserve rsvPeople" style="display:none;" id="roomCntArea">
		                ...
		                <ul class="notiList1">
		                	...
		                	<li>어린이 : 37개월 이상 ~ 만 12세 이하 (베트남 : 만 6세 이상 ∼ 만 11세까지)</li><li class="last">유아 : 36개월 이하 (베트남 : 만 5세 이하)</li></ul>
		              </div>
		              	<div class="btnList">
							<a href="#none" class="btnSubmit">
</a><a href="#none" class="" id=""><img src="/images/ko/mem/new_2019/reserve_step1_ok.gif" alt="확인" id="keywordAreaBtn"></a>
			...
			<div id="comparePop" style="display:none">
				<div class="popLayer popLayerCompare2 new_popLayer" tabindex="-1">
					...
					<div class="popCtn new_rsvBox scroll" style="max-height: 827px;">
...
<div id="webDomain" style="display: none;">
 ...
 https://www.shilla.net/
</div> 
<div id="stayDomain" style="display: none;">
 
https://www.shillastay.com/
</div>
...
<script type="text/javascript" id="">var prd_array=[],room_cnt=document.getElementById("tempRoomCnt").getAttribute("value");room_cnt=Number(room_cnt);for(var i=0;i<room_cnt;i++)prd_array.push({item_name:google_tag_manager["rm"]["32068102"](70),item_id:google_tag_manager["rm"]["32068102"](71)+"_Room"+(i+1),quantity:google_tag_manager["rm"]["32068102"](72)});var dataLayer=window.dataLayer||[];
window.dataLayer.push({event:"eec.list",hotel:google_tag_manager["rm"]["32068102"](73),checkInDate:google_tag_manager["rm"]["32068102"](74),checkOutDate:google_tag_manager["rm"]["32068102"](75),numberOfNights:google_tag_manager["rm"]["32068102"](76),timeDifference:google_tag_manager["rm"]["32068102"](77),numberOfRooms:google_tag_manager["rm"]["32068102"](78),numberOfGuests:google_tag_manager["rm"]["32068102"](79),ecommerce:{items:prd_array}});</script><iframe allow="join-ad-interest-group" data-tagging-id="AW-412555315/DOucCPG18fcBELOw3MQB" data-load-time="1702536393486" height="0" width="0" style="display: none; visibility: hidden;" src="https://td.doubleclick.net/td/rul/412555315?random=1702536393478&amp;cv=11&amp;fst=1702536393478&amp;fmt=3&amp;bg=ffffff&amp;guid=ON&amp;async=1&amp;gtm=45He3bt0v832068102&amp;gcd=11l1l1l1l1&amp;dma=0&amp;u_w=1920&amp;u_h=1080&amp;url=https%3A%2F%2Fwww.shillahotels.com%2Fseoul%2Fresv%2Frpm%2FmemSetStep1.do&amp;ref=https%3A%2F%2Fwww.shillahotels.com%2Findex.do&amp;label=DOucCPG18fcBELOw3MQB&amp;hn=www.googleadservices.com&amp;frm=0&amp;tiba=STEP1%20%EB%82%A0%EC%A7%9C%26%EC%9D%B8%EC%9B%90%20%EC%84%A0%ED%83%9D%20%7C%20%EA%B0%9D%EC%8B%A4%EC%98%88%EC%95%BD%20%7C%20The%20Shilla%20Hotels%20%26%20Resorts&amp;value=1&amp;currency_code=KRW&amp;bttype=purchase&amp;auid=1531661487.1699604787&amp;fledge=1&amp;capi=1&amp;uaa=x86&amp;uab=64&amp;uafvl=Not_A%2520Brand%3B8.0.0.0%7CChromium%3B120.0.6099.71%7CGoogle%2520Chrome%3B120.0.6099.71&amp;uamb=0&amp;uap=Windows&amp;uapv=10.0.0&amp;uaw=0"></iframe>
</body></html>