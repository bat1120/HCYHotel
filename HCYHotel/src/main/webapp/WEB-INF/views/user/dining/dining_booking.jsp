...
<html xml:lang="ko" lang="ko" class="webkit chrome win  js portrait pc">
<head>
<meta charset="utf-8">
...
<meta name="og:title"
	content="예약 | 다이닝예약 | The Shilla Hotels &amp; Resorts">
<!-- 검색엔진용 추가 180524 -->
<meta name="keywords"
...
<script type="text/javascript" async=""
	src="https://www.google-analytics.com/analytics.js"></script>
<script type="text/javascript" async=""
	src="https://www.googletagmanager.com/gtag/js?id=G-MVMT1LF00G&amp;l=dataLayer&amp;cx=c"></script>
<script async=""
...
function popCalendarLayer(dateId , today){
	...
	if(today != '2023-12-08'){
		today = today.split("-");
		var originToday = "2023-12-08".split("-");
...
<body class="subBody joinBody" cz-shortcut-listen="true">
	...
	<link href="http://localhost/HCYHotel/common/user/css/shilla/common.css" rel="stylesheet" type="text/css">
	<link href="http://localhost/HCYHotel/common/user/css/shilla/title_ko.css" rel="stylesheet" type="text/css">
	<link href="http://localhost/HCYHotel/common/user/css/shilla/print.css" rel="stylesheet" type="text/css"
		media="print">
	<link href="http://localhost/HCYHotel/common/user/css/shilla/reserve_new.css" rel="stylesheet"
		type="text/css">
	<link href="http://localhost/HCYHotel/common/user/css/shilla/btn.css" rel="stylesheet" type="text/css">
	<link href="http://localhost/HCYHotel/common/user/css/shilla/lang-ko_N.css" rel="stylesheet"
		type="text/css">
	<link href="http://localhost/HCYHotel/common/user/css/shilla/swiper.min.css" rel="stylesheet"
		type="text/css">
	...
	<script src="/js/style.advance.js" charset="UTF-8"></script>
	<!-- 개선 : js 추가 -->
	<script src="/js/resv/advResvCalendarFb.js" charset="UTF-8"></script>
	<!-- [2019_모션추가]3 달력 고도화 -->
	...
	<script src="/js/resv/resv.js?dt=20231208" charset="UTF-8"></script>
	...
	<!-- 2017추가 -->
	<script src="/js/jquery.jsSelect.js" charset="UTF-8"></script>
	<!-- 2017추가 -->
	<!-- 개별 step1 end-->
...
var historyUrl = "";
	...
	<div id="viewLoading" class="re-loader"
		style="z-index: 99999; margin-left: -101.5px; margin-top: -84px; position: fixed; top: 50%; left: 50%; display: none;">
	...
	<div id="popPeopleChInfo" class="usepop" style="display: none">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			tabindex="0"
			style="width: 430px; position: fixed; top: 50%; left: 50%; margin-left: -215px; margin-top: -106px;"
			aria-hidden="false">
			<div class="popHead">
				<h2 class="tit">예약 인원 입력 안내</h2>
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popPeopleChInfo'); return false;"><span>닫기</span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt mgb15">
					<span>예약인원 입력 후, 날짜를 검색해주시기 바랍니다.</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popPeopleChInfo'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
				<a class="btnClose" href="#"
	...
	<div id="popPersonInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popPersonInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div id="popPersonInfoHidden" style="display: none;">
				<p class="checkTxt mgb15">
					<span>$좌석$은(는) 최소 $최소$명부터 최대 $최대$명까지 이용 가능합니다.</span>
				</p>
				<ul class="notiList2">
			...
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<div id="popPersonInfoText"></div>
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popPersonInfo'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popPeopleChInfo2" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popPeopleChInfo2'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				...
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popPeopleChInfo2'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popReplayInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popReplayInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<ul class="notiList2">
				...
				<p class="checkTxt">
					<span>다시 선택해주시기 바랍니다.</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popReplayInfo'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popSetInit" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popSetInit'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div style="display: none" id="popSetInitHidden">
				<p class="checkTxt">
					<span>$변수$ 변경 시 검색결과가 초기화 됩니다.</span>
				</p>
				<!--  -->
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<div id="popSetInitText"></div>
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popSetInit'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_cancel.jpg" alt="취소"></a>
					<a href="#" onclick="" id="setInitEvent"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popCardInfo" style="display: none">
		<div class="popLayer popLayerRegistCard new_popLayer" tabindex="-1">
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popCardInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox">
				<h3 class="cardInfoTit">
					<span id="mbrRegDt"></span>&nbsp;등록하신 카드정보
					<!-- 등록하신 카드정보 -->
				</h3>
				<table class="tableType2">
					<caption>
						<!-- 카드 번호, 카드 종류, 유효기간 으로 구성된 등록된 카드 정보 -->
					</caption>
					<colgroup>
				...
				<ul class="notiList1">
					<li class="first">신용카드 정보는 고객님의 당일 취소 또는 노쇼(No- Show)에 의한 개런티
						외에는 어떤 목적으로도 사용되지 않으며, 체크카드 및 일부 신용 카드의 경우 사용이 제한 될 수 있습니다.<!-- 신용카드 정보는 고객님의 당일 취소 또는 노쇼(No- Show)에 의한 개런티 외에는 어떤 목적으로도 사용되지 않으며, 체크카드 및 일부 신용 카드의 경우 사용이 제한 될 수 있습니다.  -->
					</li>
					<li class="last"><span class="fontRed">온라인 예약 시 직접 결제가
							이루어지지 않으며,</span> 최종 결제는 레스토랑에서 해주시기 바랍니다.<!-- <em class="pointColor1">온라인 예약 시 직접 결제가 이루어지지 않으며,</em> 최종 결제는 레스토랑에서 해주시기 바랍니다. --></li>
					<!-- 2020-11-19 내용 삭제 -->
				</ul>
				<p class="checkTxt">
					<span>등록하신 카드정보로 예약하시겠습니까?<!-- 등록하신 카드정보로 예약하시겠습니까? --></span>
				</p>
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popCardInfo'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_cancel.gif" alt="취소"></a>
					<a href="#" onclick="confirmCardInfo();"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popPolicy1" style="display: none">
		<div class="popLayer popLayerCCInfo new_popLayer" tabindex="-1">
			<div class="popHead">
				<h2 class="tit">
					신용카드 정보 수집 약관
					<!-- 신용카드 정보 및 개인정보 수집, 이용에 동의 -->
				</h2>
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popPolicy1'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox">
				<div class="termsWrap">
							...
							<dl class="mt15">
								...
								<dd class="termsList1 bold">
									<ol class="termsList1 bold">
										<li>① <span class="txtBline">수집 이용 항목 | 카드정보(카드종류,
												카드번호, 유효기간)</span></li>
										<li>② <span class="txtBline">수집 이용 목적 | 호텔 다이닝 예약
												시 저장하신 결제정보 활용</span>
											<p class="fNormal">* 신용카드 정보 수집으로 직접 결제가 이루어지는 것은 아니며, 다음
												호텔 다이닝 예약 이용 시 카드정보를 다시 입력하지 않아도 되는 편의 제공 목적입니다.</p>
										</li>
										<li>③ <span class="txtBline">보유 이용 기간 | 예약일 후 1년</span></li>
									</ol>
								</dd>
								<p class="mt15">※ 위 사항에 대한 동의를 거부할 수 있으나, 이에 대한 동의가 없을 경우 다음
									호텔 다이닝 예약 시, 다시 해당 결제 정보를 입력해야 함을 알려드립니다.</p>
							</dl>
						</div>
					</div>
				</div>
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popPolicy1'); return false;">
						<img src="../../images/ko/mem/new_2019/btn_card_complete.gif"
						alt="확인">
					</a>
				</div>
			</div>
	...
	<div id="popAreaInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popAreaInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
				...
				<ul class="notiList1">
					<li class="first">선호 구역은 온라인에서만 제공되는 서비스로 일부에 한 해 예약 가능하며,
						예약완료 순으로 마감됩니다.</li>
					<li class="last">전화문의로 구역 선택 및 변경, 취소는 불가합니다.</li>
				</ul>
				<!--  -->
				<div class="btnBox">
					<a href="#" onclick="backStep(2)"><img
						src="../../images/ko/mem/new_2020/resv_zone.jpg" alt="구역 재선택"></a>
					<a href="#" onclick="initArea();"><img
						src="../../images/ko/mem/new_2020/resv_progress.jpg" alt="예약 진행"></a>
				</div>
			</div>
			<div class="btnAcc">
				<a class="btnClose" href="#"
	...
	<div id="popAutNumMiss" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popAutNumMiss'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
				...
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popAutNumMiss'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
				<a class="btnClose" href="#"
	...
	<div id="popNumOverInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popNumOverInfo'); return false;"><span>닫기</span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>인증번호 전송 횟수가 초과되었습니다.</span>
				</p>
				<ul class="notiList2">
				...
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popNumOverInfo'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popAutNumTimeOver" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popAutNumTimeOver'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>인증번호 입력 시간을 초과했습니다.</span>
				</p>
				<ul class="notiList2">
				...
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popAutNumTimeOver'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popCardSave" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="javascript:void(0);"
						onclick="fncCardSaveYn('N');"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop">
				...
				<!--  -->
				<div class="btnBox">
					<a href="javascript:void(0);" onclick="fncCardSaveYn('N');"><img
						src="../../images/ko/mem/new_2019/btn_disagree.gif" alt="미동의"></a>
					<a href="javascript:void(0);" onclick="fncCardSaveYn('Y');"><img
						src="../../images/ko/mem/new_2019/btn_agree.gif" alt="동의"></a>
				</div>
			</div>
			<div class="btnAcc">
				<a class="btnClose" href="javascript:void(0);"
					onclick="pc.layerPopup.closePop('#popCardSave'); return false;"><span>닫기<!-- 닫기 --></span></a>
			</div>
		</div>
		<div class="mdScreen" style="display: block; height: 1048px;"></div>
	</div>
	...
	<div id="popAutNumConfirm" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popAutNumConfirm'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>인증번호가 정상적으로 확인되었습니다.</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popAutNumConfirm'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popOverlapResvComfirm" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popOverlapResvComfirm'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>온라인 예약이 가능합니다.</span>
				</p>
				<ul class="notiList2 mgb5">
					<li class="first last">※ 동일 날짜의 동일 시간대에 온라인과 유선으로 예약한 내역이 중복으로
						확인될 경우 단 건으로 처리될 수 있습니다.</li>
				</ul>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popOverlapResvComfirm'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popPhonNumConfirm" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popPhonNumConfirm'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>휴대전화 번호를 올바르게 입력하시기 바랍니다.</span>
				</p>
				<ul class="notiList2">
					<li class="first last">※ 온라인 예약 시, 올바른 예약 정보 확인을 위해 <br>
						휴대전화로만 예약이 가능합니다.
					</li>
				</ul>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popPhonNumConfirm'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popPriceInfo" style="display: none">
		<div class="popLayer new_popLayer diningPop" tabindex="-1"
			style="width: 430px;">
			<div class="popHead">
				<h2 class="tit">
					운영시간 안내
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popPriceInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox">
				...
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popPriceInfo'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popReset" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popReset'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<ul class="notiList2">
				...
				<p class="checkTxt">
					<span>초기화 하시겠습니까?</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popReset'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_cancel.jpg" alt="취소"></a>
					<a href="javascript:void(0);" onclick="resetResv();"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
				<a class="btnClose" href="#"
					onclick="pc.layerPopup.closePop('#ResvResetPop'); return false;"><span>닫기<!-- 닫기 --></span></a>
			</div>
		</div>
		<div class="mdScreen" style="display: block; height: 1048px;"></div>
	</div>
	...
	<div id="popNoticeInfoPo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popNoticeInfoPo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>개인정보 수집 및 이용에 대한 약관에 <br> 동의해주시기 바랍니다.
					</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popNoticeInfoPo'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popRsvOverInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			tabindex="-1" style="width: 430px; z-index: 999999;">
			<div class="popHead">
				<h2 class="tit">
					예약가능 시간 초과 안내
					<!-- 예약가능 시간초과 안내 -->
				...
				<div class="btn">
					<a class="btnClose" href="/index.do?lang=ko"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<ul class="notiList2">
				...
				<p class="checkTxt">
					<span>다시 예약을 진행하시겠습니까?</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="/index.do?lang=ko"><img
						src="../../images/ko/common/mypage/btn_card_cancel.gif"
						alt="예약 취소"></a> <a href="javascript:void(0);"
						onclick="timeOverBlockage()"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
				<a class="btnClose" href="#"
					onclick="pc.layerPopup.closePop('#popRsvOverInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
			</div>
		</div>
		<div class="mdScreen" style="display: block; height: 1048px;"></div>
	</div>
	...
	<div id="popAlertInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popAlertInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div style="display: none" id="popAlertInfoHidden">
				<p class="checkTxt">
					<span>$변수$를(을) 확인해주시기 바랍니다.</span>
				</p>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<div id="popAlertInfoText"></div>
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popAlertInfo'); return false;"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popOverlapInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popOverlapInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>동일한 날짜와 시간대에<br> 이미 레스토랑 예약이 있습니다.<br> 예약 날짜
						또는 시간을 변경하시겠습니까?
					</span>
				</p>
				<ul class="notiList2 mgb5">
				...
				<!--  -->
				<div class="btnBox">
					<a href="#" onclick="overlapClose();"><img
						src="../../images/ko/mem/new_2020/resv_confirm.jpg" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popOverlapCntInfo" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popOverlapCntInfo'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>해당 레스토랑의 온라인 예약 가능 횟수가 초과되었습니다.</span>
				</p>
				<ul class="notiList2">
					<li class="first last">추가 예약 문의는 전화해주시기 바랍니다.</li>
				</ul>
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popOverlapCntInfo'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popAlertInfo3" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popAlertInfo3'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt mgb15">
					<span>유의사항을 모두 읽고 확인해 주시기 바랍니다.</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popAlertInfo3'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popSysErr" class="usepop" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			tabindex="-1" style="width: 430px; z-index: 9999999;">
			<div class="popHead">
			...
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				...
				<ul class="notiList2">
					<li class="first">현재 접속 고객이 많아 서비스 이용이 원활하지 않습니다.</li>
					<!--<li>현재 시스템 점검으로 인하여 서비스 이용이 원활하지 않습니다.</li>  -->
					<li class="last">고객 여러분의 양해 부탁드리며, <br> 예약 및 문의는 전화해주시기
						바랍니다.
					</li>
				</ul>
				<!--  -->
				<div class="btnBox">
					...
					<a href="javascript:void(0);" onclick="sysErrMove();"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popNoReady" class="usepop" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			tabindex="-1" style="width: 430px; z-index: 9999;">
			<div class="popHead">
				<h2 class="tit"></h2>
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popAlertInfo3'); return false;"><span>닫기</span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				잠시 후 예약이 오픈됩니다.<br>원활한 예약 진행을 위해 잠시만 기다려주시기 바랍니다.<br>
				<br>* 매월 1일 7:30~8:00, 15일 08:30~09:00는 오픈을 위한 대기시간입니다.<br>*
				각 레스토랑에 따라 예약 오픈일이 상이합니다.<br> [매월 1일]<br> - 오전 8시 : 서울신라호텔
				'더 파크뷰'<br> - 오전 9시 : 제주신라호텔 '더 파크뷰'<br> [매월 15일]<br>
				- 오전 9시 : 서울신라호텔 '팔선', '아리아께', '콘티넨탈', '라연'<br>
				<div class="btnBox">
					<!-- <a href="#" onclick="pc.layerPopup.closePop('#ResvResetPop'); return false;"><img src="../../images/ko/mem/new_2020/resv_cancel.jpg" alt="취소"></a> -->
					<a href="javascript:void(0);"
						onclick="pc.layerPopup.closePop('#popNoReady'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popRsvCancel" style="display: none">
		<div class="popLayer popLayerRsvCancel new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popRsvCancel'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox">
				<ul class="notiList2">
				...
				<div class="checkTxt mgt10">
					<span>예약을 취소하시겠습니까?</span>
				</div>
				<!--  -->
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popRsvCancel'); return false;"><img
						src="../../images/ko/common/mypage/btn_card_cancel.gif" alt="취소"></a>
					<a href="#" onclick="cancelResv();"><img
						src="../../images/ko/common/mypage/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
				<a class="btnClose" href="#"
	...
	<div id="popShowArea" style="display: none">
		<div class="popLayer new_popLayer diningPop" tabindex="-1"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="javascript:void(0);"
						onclick="pc.layerPopup.closePop('#popShowArea');"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox">
				<div class="diningImg">
	...
	<div id="comparePop2" style="display: none;">
		<div class="popLayer popLayerCompare new_popLayer" tabindex="-1"
			style="z-index: 9990;">
			<div class="popHead">
				<h2 class="tit">
					예약정보
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#comparePop2'); return false;"><span>닫기<!-- 닫기 --></span>
					</a>
				</div>
			</div>
			<div class="popCtn pop_rsvInfo_wrap new_rsvBox">
								...
								<dd>
									...
									<dl class="con" style="display: none;">
										...
										<dd>
											성인
											<!-- 성인 -->
											<span class="popInfo"></span>, 어린이
											<!-- 어린이 -->
											<span class="popInfo"></span>, 유아
											<!-- 유아  -->
											<span class="popInfo"></span>
										</dd>
									</dl>
				...
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#comparePop2'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_cancel.gif" alt="취소"></a>
					<a href="javascript:void(0);" onclick="backStep('2')"><img
						src="../../images/ko/mem/new_2019/btn_rsv_modify.gif" alt="수정"></a>
					<!-- 수정 2019-10-10 -->
					<a href="javascript:void(0);" onclick="regResv();"><img
						src="../../images/ko/mem/new_2019/btn_rsv_complete.gif" alt="예약완료"></a>
				</div>
			</div>
		</div>
		<div class="mdScreen" style="display: block; height: 1048px;"></div>
	...
	<div id="popFoodAll" style="display: none;">
		<div class="popLayer popLayerFoodAllSave new_popLayer diningPop"
			tabindex="0" aria-hidden="false">
			<div class="popHead">
				<h2 class="tit">민감정보 저장 약관 동의 알림</h2>
				<div class="btn">
					<a class="btnClose" href="javascript:void(0);"
						onclick="pc.layerPopup.closePop('#popFoodAll'); return false;"><span>닫기</span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop">
				<ul class="notiList2 mgb15">
					<li class="first last">알레르기 정보 수집을 위해 동의가 필요합니다. <br> 미동의
						시 선택한 정보는 삭제됩니다.<br>
					</li>
				</ul>
				<p class="checkTxt">
				...
				<div class="btnBox">
					<a href="javascript:void(0);"
						onclick="fncFoodAllYn('N');return false;"><img
						src="../../images/ko/mem/new_2019/btn_disagree.gif" alt="미동의"></a>
					<a href="javascript:void(0);"
						onclick="fncFoodAllYn('Y');return false;"><img
						src="../../images/ko/mem/new_2019/btn_agree.gif" alt="동의"></a>
				</div>
			</div>
			<div class="btnAcc">
	...
	<div id="popOverlapInfoPb" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popOverlapInfoPb'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>당일 온라인 예약 가능 횟수가 초과되었습니다.</span>
				</p>
				<!--  -->
				<div class="btnBox">
					<a href="#" onclick="overlapClose();"><img
	...
	<div id="popOverlapCntInfoPb" style="display: none;">
		<div class="popLayer popLayerRegistCard new_popLayer diningPop"
			...
			<div class="popHead">
				...
				<div class="btn">
					<a class="btnClose" href="#"
						onclick="pc.layerPopup.closePop('#popOverlapCntInfoPb'); return false;"><span>닫기<!-- 닫기 --></span></a>
				</div>
			</div>
			<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
				<p class="checkTxt">
					<span>해당 월 온라인 예약 가능 횟수가 초과되었습니다.<br> ※ 추가 예약 문의는 패스트리
						부티크로 전화 주시기 바랍니다.
					</span>
				</p>
				<div class="btnBox">
					<a href="#"
						onclick="pc.layerPopup.closePop('#popOverlapCntInfoPb'); return false;"><img
						src="../../images/ko/mem/new_2019/btn_card_complete.gif" alt="확인"></a>
				</div>
			</div>
			<div class="btnAcc">
...
.snsList li a {
	...
	float: left;
					...
					<link href="http://localhost/HCYHotel/common/user/css/shilla/n_common.css" rel="stylesheet"
						type="text/css">
					<script type="text/javascript" src="/js/fbr/fbrSkin.js"
						charset="UTF-8"></script>
					<script type="text/javascript" src="/js/fbr/jquery.ad-gallery.js"></script>

					<input type="hidden" value="" name="netFunnelIsOn"
						id="netFunnelIsOn" autocomplete="off">
					<div id="accViewPop" style="display: none">
						<div class="popLayer new_popLayer diningPop">
							<div class="popHead">
								<h2 class="tit"></h2>
								<div class="btn">
									<a id="accViewPopCloseBtn" class="btnClose" href="#none"
										onclick="fncLayerClose('accViewPop', 'roomViewMd');"><span>닫기</span></a>
								</div>
							</div>
							<div class="popCtn" style="height: 600px; overflow-y: scroll;"
								id="accView">
								...
								<div class="conWrap mgt40">
									...
									<div class="rightArea" id="rightArea">
										<div class="dnBox" id="dnBox"></div>
									</div>
								</div>
							</div>
							<div class="btnAcc">
								<a class="btnClose" href="#none"
									onclick="fncLayerClose('accViewPop', 'roomViewMd');"><span>확인<!-- 확인 --></span></a>
							</div>
						</div>

						<div class="mdScreen" style="display: block; height: 1048px;"
							id="roomViewMd"></div>
					</div>
					...
					<div id="popSelectInfo" style="display: none;">
						<div class="popLayer popLayerRegistCard new_popLayer diningPop"
							...
							<div class="popHead">
								...
								<div class="btn">
									<a class="btnClose" href="#"
										onclick="pc.layerPopup.closePop('#popSelectInfo'); return false;"><span>닫기</span></a>
								</div>
							</div>
							<div class="popCtn new_rsvBox diningPop" style="width: 430px;">
								<p class="checkTxt mgb15">
									<span><span id="selectHD"></span>을 선택해주시기 바랍니다.<!-- 을 선택해주시기 바랍니다. --></span>
								</p>
								<div class="btnBox">
									<a href="#"
										onclick="pc.layerPopup.closePop('#popSelectInfo'); return false;"><img
										src="../../images/ko/mem/new_2019/btn_card_complete.gif"
										alt="확인"></a>
								</div>
							</div>
							<div class="btnAcc">
					...
					<div class="new_rsvBox diningNew">
						<div class="rsvStepWrap">
							<div class="rsvStepList step0">
								<ul>
									<li class="step0 first last"><span>현재단계</span><img
										src="../../images/ko/mem/new_2020/diningRsv_step0_on.png"
										alt="Step0. 다이닝 예약"></li>
								</ul>
							</div>
						</div>
						<div class="rsvWrap diningHotelBox_N">
							...
							<div class="rsvSchHotel">
								<div class="rsvSchCont">
									<dl>
										<dt>
											<img src="../../images/ko/mem/new_2020/diningTit_hotel.png"
												alt="호텔 선택">
										</dt>
										<dd class="diningChList">
											<ul class="hotelList2">
												<li class="first"><a href="javascript:void(0)"
													onclick="getDiningList(this);" hotlid="S"
													class="hotlIdClass ">서울신라호텔</a></li>
												<li><a href="javascript:void(0)"
													onclick="getDiningList(this);" hotlid="C"
													class="hotlIdClass ">제주신라호텔</a></li>
												<li class="last"><a href="javascript:void(0)"
													onclick="getDiningList(this);" hotlid="SS"
													class="hotlIdClass ">신라스테이</a></li>
											</ul>
										</dd>
									</dl>
								</div>
								...
								<div class="rsvSchCont clearfix">
									<dl>
										<dt>
											<img src="../../images/ko/mem/new_2020/diningTit_dining.png"
												alt="다이닝 선택">
										</dt>
										<dd class="optionList diningChList2">
											...
											<div class="diningBtnSearch fr">
												<a href="javascript:void(0);" onclick="goStep2()"><img
													src="../../images/ko/mem/new_2020/btn_diningRsv.gif"
													alt="예약"></a>
											</div>
										</dd>
									</dl>
							...
							<div class="diningStay_N diningPop" id="popStayLayerInfo">
								...
								<div class="hHead">
									<strong><img
										src="../../images/ko/mem/new_2020/shillaStayTit.png"
										alt="신라스테이 다이닝 예약"></strong>
								</div>
								<div class="hCon">
									<p class="spNoticeTxt">
										※ 신라스테이 다이닝 예약은 본 사이트에서는 예약 조회가 되지 않으며, 예약 후 받으신 이메일 또는
										문자(알림톡)로 확인 가능합니다.<br> ※ 레스토랑 Cafe에 한해 온라인 예약이 가능하며,
										신라스테이 제주점은 전화 예약만 가능합니다.
									</p>
									<div class="list2">
										<!-- 2020-11-25 링크 변경 -->
										<dl>
											<dt>
												<a href="https://www.shillastay.com/"> <img
													src="../../images/ko/mem/new_2019/main_tab2_tit1.gif"
													alt="국내">
												</a>
											</dt>
											<dd>
												<strong class="tit"> <img
													src="../../images/ko/mem/new_2019/main_tab2_stit1.gif"
													alt="서울 강북">
												</strong>
												<ul>
													<li class="first"><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastaygwanghwamun">신라스테이
															광화문</a></li>
													<li><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastaymapo">신라스테이
															마포</a></li>
													<li class="last"><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayseodaemun">신라스테이
															서대문</a></li>
												</ul>
											</dd>
											<dd>
												<strong class="tit"><img
													src="../../images/ko/mem/new_2019/main_tab2_stit2.gif"
													alt="서울 강남"></strong>
												<ul>
													<li class="first"><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayyeoksam">신라스테이
															역삼</a></li>
													<li><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayseocho">신라스테이
															서초</a></li>
													<li><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayguro">신라스테이
															구로</a></li>
													<li class="last"><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastaysamsung">신라스테이
															삼성</a></li>
												</ul>
											</dd>
											<dd>
												<strong class="tit"><img
													src="../../images/ko/mem/new_2019/main_tab2_stit3.gif"
													alt="전국"></strong>
												<ul>
													<li class="first"><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastaydongtan">신라스테이
															동탄</a></li>
													<li><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastaycheonan">신라스테이
															천안</a></li>
													<li><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayulsan">신라스테이
															울산</a></li>
													<li><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayhaeundae">신라스테이
															해운대</a></li>
													<li><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayseobusan">신라스테이
															서부산</a></li>
													<li class="last"><a href="#"
														stayurl="https://app.catchtable.co.kr/ct/shop/shillastayyeosu">신라스테이
															여수</a></li>
												</ul>
											</dd>
										</dl>
									...
									<div class="btnList">
										...
										<a href="javascript:void(0);" onclick="stayLinkMove()"
											id="stayResvBtn"> <img id="keywordAreaBtn"
											src="../../images/ko/mem/new_2020/step0_confirm_deful.jpg"
											alt="예약확인" draggable="false">
										</a>
									</div>
								</div>
								<a href="javascript:void(0);" onclick="stayInitClose();"
									class="btnStayClose">닫기<!-- 닫기 --></a>
							</div>
							<div class="mdScreen" style="height: 1048px;"></div>
						</div>
						<!-- 호텔, 다이닝 선택 전 기본 메세지 영역 -->
						<div class="rsvDescWrap beforeSearchDining" id="beforeSearchWrap">
							<div class="rsvDescDefault">
								예약을 원하시는 호텔, 다이닝을 선택해주세요.
								<!-- 예약을 원하시는 호텔, 다이닝을 선택해주세요. -->
							</div>
						</div>
						<!-- //호텔, 다이닝 선택 전 기본 메세지 영역 -->
							...
							<div class="rsvResultCon">
								<div class="rsvResultList rsvResultDiningList">
									<ul class="clearfix diningDetail">
										<li class="first">
											<!-- 선택한 레스토랑 이미지 영역 --> <img src="" alt="선택한 레스토랑 이미지"
											id="imgSrc">
										</li>
										<li class="last">
											<!-- 선택한 레스토랑 정보 영역 -->
											...
											<p>
												<!-- 선택된 레스토랑별 상세로 이동합니다. -->
												<a class="btnBenfitInfo" href="javascript:void(0);"
													id="linkPage" onclick="detailPop(this)">자세히 보기<!-- 자세히보기 --></a>
											</p>
...
//STEP1---------------------------------------------------------------------------------END
					...
					<div class="localBoxer">
						...
						<div class="brandWrap">
							<div class="brand">
								<dl>
									<dt>
										<a href="/index.do">The Shilla</a>
									</dt>
								</dl>
							</div>
							<div class="brandMono">
								<a href="https://www.shillamonogram.com/mghub/index.do?lang=ko">신라모노그램</a>
							</div>
							<div class="brandStay">
								<a href="https://www.shillastay.com/stayhub/index.do">신라스테이</a>
							</div>
						</div>
						<div class="linkInfo">
							<dl class="introduction">
								<dd class="d1">
									<a href="/membership/inquires/aboutShilla/memOverView.do"><span>호텔신라
											소개</span></a>
								</dd>
								<dd class="d2">
									<a href="/membership/inquires/hotelDevelopment.do"><span>호텔
											개발</span></a>
								</dd>
								<dd class="d3">
									<a href="/membership/inquires/contactus/memIndex.do"><span>고객문의</span></a>
								</dd>
								<dd class="d8">
									<a href="/membership/inquires/aboutShilla/memSiteMap.do"><span>사이트맵</span></a>
								</dd>
								<dd class="d4">
									<a href="/membership/inquires/memChangeRewards.do"><span>신라리워즈
											전환 안내</span></a>
								</dd>
								<dd class="d5">
									<a href="https://www.theshilla.shop/" target="_blank"><span>The
											Shilla shop</span></a>
								</dd>
								<dd class="d6">
									<a href="https://www.samsunggiftcard.net/common/sgc/index.html"
										target="_blank"><span>삼성상품권</span></a>
								</dd>
								<dd class="d7">
									<a href="#" onclick="oldHopenO('oldHpopup'); return false;"><span>신라리워즈
											전환 안내</span></a>
								</dd>
							</dl>
							<dl class="inquiries">
								<dt class="dt">SNS</dt>
								<dd class="insta">
									<a title="Instagram - popup" target="_blank"
										href="https://www.instagram.com/shillahotels/"><span>Instagram</span></a>
								</dd>
								<dd class="facebook">
									<a title="Facebook - popup" target="_blank"
										href="http://www.facebook.com/theshillahotels"><span>Facebook</span></a>
								</dd>
								<dd class="weibo">
									<a title="Weibo - popup" target="_blank"
										href="http://weibo.com/shillahotel"><span>Weibo</span></a>
								</dd>
								<dd class="youtube">
									<a title="Youtube - popup" target="_blank"
										href="https://www.youtube.com/@theshillahotelsresorts9834"><span>Youtube</span></a>
								</dd>
							</dl>
				...
				<div id="oldHpopup">
					...
					<div class="oldHwrap" style="z-index: 999;">
						<div class="ctnTitle">
							...
							<div class="close">
								<a href="#" onclick="oldHopenC('oldHpopup'); return false;">
									<img src="/images/ko/mem/reservation/step1Infoclose.gif"
									alt="닫기">
								</a>
							</div>
						</div>
						<div class="ctnWrap">
							...
							<p>* 호텔신라는 고택 예약 서비스를 직접 운영하지 않으며, 본 사이트는 고택 소개 정보만을 제공하고 있음을
								알려드립니다.</p>
							<p>신라호텔 고객의 문의 및 의견과 관련하여 귀사가 아래와 같이 본인의 개인정보를 수집 및 이용하는데
								동의합니다.</p>
							<div class="btnCtn">
								<a class="oldHbtn" href="http://gyeongbukgotaek.modoo.at"
	...
	<form id="submitForm" method="post" name="submitForm">
		<input type="hidden" id="pageIndex" value="1" class="saveField"
			autocomplete="off"> <input type="hidden" id="resvId"
			name="resvId" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="hotlId" name="hotlId" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="shopId" name="shopId" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitDate"
			name="visitDate" value="" alerttext="[날짜]" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitTime"
			name="visitTime" value="" alerttext="[방문예정시간]" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitAdlt"
			name="visitAdlt" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="visitChld" name="visitChld" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="visitInnt" name="visitInnt" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitName"
			name="visitName" value="" alerttext="[성명]" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitNameFirst"
			name="visitNameFirst" value="" alerttext="[성명]첫번쨰" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitNameLast"
			name="visitNameLast" value="" alerttext="[성명]두번쨰" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitPhon"
			name="visitPhon" value="" alerttext="[연락처]" class="saveField"
			autocomplete="off"> <input type="hidden" id="visitEmail"
			name="visitEmail" value="" alerttext="[이메일]" class="saveField"
			autocomplete="off"> <input type="hidden" id="resvTypeCd"
			name="resvTypeCd" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="resvLangCd" name="resvLangCd" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="resvStateCd" name="resvStateCd" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="allgyCd"
			name="allgyCd" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="allgyEtcCd" name="allgyEtcCd" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="chairText" name="chairText" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="chairTextLang"
			name="chairTextLang" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="addEtc" name="addEtc" value=""
			class="saveField" alerttext="[추가요청사항]" autocomplete="off"> <input
			type="hidden" id="prefAreaCd" name="prefAreaCd" value=""
			alerttext="[선호 구역]" class="saveField" autocomplete="off"> <input
			type="hidden" id="cardTypeCd" name="cardTypeCd" value=""
			alerttext="[카드 종류]" class="saveField" autocomplete="off"> <input
			type="hidden" id="cardNo" name="cardNo" value=""
			alerttext="[유효한 카드번호]" class="saveField" autocomplete="off">
		<input type="hidden" id="cardExprYm" name="cardExprYm" value=""
			alerttext="[카드유효기간]" class="saveField" autocomplete="off"> <input
			type="hidden" id="diniCho" name="diniCho" value="" alerttext="[시간]"
			class="saveField" autocomplete="off"> <input type="hidden"
			id="visitGender" name="visitGender" value="" alerttext="[성별]"
			class="saveField" autocomplete="off"> <input type="hidden"
			id="step2NotiYn" name="step2NotiYn" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="rewardNo"
			name="rewardNo" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="smsCertYn" name="smsCertYn"
			alerttext="[휴대폰 인증]" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="resvSeatType" name="resvSeatType"
			alerttext="[좌석유형]" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="roomType" name="roomType" value=""
			alerttext="[룸]" autocomplete="off"> <input type="hidden"
			id="roomTypeText" name="roomTypeText" value="" autocomplete="off">
		<input type="hidden" id="roomPerson" name="roomPerson" value=""
			autocomplete="off"> <input type="hidden" id="preUpdateDate"
			name="preUpdateDate" value="" autocomplete="off"> <input
			type="hidden" id="preUpdateDiniCho" name="preUpdateDiniCho" value=""
			autocomplete="off"> <input type="hidden" id="preUpdateTime"
			name="preUpdateTime" value="" autocomplete="off"> <input
			type="hidden" id="updateYn" name="updateYn" value=""
			autocomplete="off"> <input type="hidden" id="allgyMemo"
			name="allgyMemo" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="allgyText" name="allgyText" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="allgyAgreeYN" name="allgyAgreeYN" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="prefAreaText"
			name="prefAreaText" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="blockageId" name="blockageId" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="blockDelTime" name="blockDelTime" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="blockCreTime"
			name="blockCreTime" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="cardSaved" name="cardSaved" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="memo" name="memo" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="confirmNum" name="confirmNum" value=""
			class="saveField" autocomplete="off"> <input type="hidden"
			id="searchDateSel" name="searchDateSel" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="searchDateGubun"
			name="searchDateGubun" value="" class="saveField" autocomplete="off">
		<input type="hidden" id="searchDateType" name="searchDateType"
			value="" class="saveField" autocomplete="off"> <input
			type="hidden" id="sDate" name="sDate" value="" class="saveField"
			autocomplete="off"> <input type="hidden" id="eDate"
			name="eDate" value="" class="saveField" autocomplete="off"> <input
			type="hidden" id="randAreaYn" name="randAreaYn" value=""
			autocomplete="off">
		<!-- 비회원 중복예약체크 -->
		<input type="hidden" id="natCd" name="natCd" value=""
			alerttext="[연락처]" autocomplete="off"> <input type="hidden"
			id="natCdIdx" name="natCdIdx" value="" autocomplete="off"> <input
			type="hidden" id="checkGift" name="checkGift" value=""
			autocomplete="off"> <input type="hidden" id="checkCake"
			name="checkCake" value="" autocomplete="off"> <input
			type="hidden" id="giftCnt" name="giftCnt" value="" autocomplete="off">
		<input type="hidden" id="cakeCnt" name="cakeCnt" value=""
			autocomplete="off"> <input type="hidden" id="selectGiftSn"
			name="selectGiftSn" value="" autocomplete="off"> <input
			type="hidden" id="resvCategory" name="resvCategory" value=""
			autocomplete="off">
	</form>

	<script type="text/javascript" id="">document.all&&!document.addEventListener||window.proxied_alert||(window.proxied_alert=window.alert,window.alert=function(){var a=arguments[0]?arguments[0]:"null";dataLayer.push({event:"alert_showed",alert_message:a});return proxied_alert.apply(this,arguments)});</script>
	<script type="text/javascript" id="">(function(){var b=document.querySelector("select#diningSel"),c=function(a){a=a.target.options[a.target.selectedIndex];window.dataLayer.push({event:"selectionMade",selectedElement:a})};b.addEventListener("change",c,!0);0<document.querySelector("#diningSel").selectedIndex&&window.dataLayer.push({event:"selectionMade",selectedElement:document.querySelector("#diningSel").selectedOptions[0]})})();</script>
...
browsingBehavior:n})}})();</script>
	<script type="text/javascript" id="">var resvType=google_tag_manager["rm"]["32068102"](78);sessionStorage.setItem("_resvType",resvType);</script>
</body>
</html>