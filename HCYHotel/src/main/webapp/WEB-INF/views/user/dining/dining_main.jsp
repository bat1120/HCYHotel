  ...
  <path class="cls-1"
							...
							<div class="fv-6-right-section">
								<select id="userMenu" class="form-select"
									...
									<option value="http://192.168.10.147/HCYHotel/user/review/myreview/myroomreview_list.do">나의 호텔 후기</option>
									<option value="http://192.168.10.147/HCYHotel/user/review/myreview/mydiningreview_list.do">나의 다이닝 후기</option>
					...
					<div class="Seuf">
						...
						function diningreservation(){
							...
							<button type="button" class="btn btn-dark"
								onclick="diningreservation()" style="margin-left: 1200px;">다이닝 예약하기</button>
										...
										<div class="c-5pd-list">
											<div class="c-5pd-inner">
													...
													<div role="group" aria-label="8개 중 1번째 항목">
														<a
															href="http://192.168.10.147/HCYHotel/user/dining/dining_info.do"
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																 <div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000042_1.jpg"/>
																</div> 
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: 'http://192.168.10.147/HCYHotel/common/business/img/D000042_1.jpg'"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
																<h5 class="FNY6-title">뇸뇸</h5>
																<div class="esgW"></div>
															</div> </a>
													</div>
													...
													<div role="group" aria-label="8개 중 2번째 항목">
														<a
															...
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																<div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000003.jpg"/>
																</div>
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: http://192.168.10.147/HCYHotel/common/business/img/D000003.jpg"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
																<h5 class="FNY6-title">아리아떼</h5>
																<div class="esgW"></div>
															</div> </a>
													</div>
													<div role="group" aria-label="8개 중 3번째 항목">
														<a
															...
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																<div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000005.jpg"/>
																</div>
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: http://192.168.10.147/HCYHotel/common/business/img/D000005.jpg"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
													...
													<div role="group" aria-label="8개 중 4번째 항목">
														<a
															...
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																<div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000004.jpg"/>
																</div>
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: http://192.168.10.147/HCYHotel/common/business/img/D000004.jpg"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
																<h5 class="FNY6-title">화이트</h5>
																<div class="esgW"></div>
															</div> </a>
													</div>
						...
						<section class="bDbo bDbo-spacing-bottom"
							...
							<div class="kml-layout edges-s snap">
								<header class="KzeV">
									<div class="KzeV-header">
										<div class="KzeV-info">
											<div class="KzeV-title">지금 뜨는 다이닝</div>
													...
													<div role="group" aria-label="8개 중 1번째 항목">
														<a
															...
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																<div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000028_1.JPG"/>
																</div>
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: http://192.168.10.147/HCYHotel/common/business/img/D000028_1.JPG"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
													...
													<div role="group" aria-label="4개 중 1번째 항목">
														<a
															...
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																<div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000009_1.JPG"/>
																</div>
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: http://192.168.10.147/HCYHotel/common/business/img/D000009_1.JPG"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
													...
													<div role="group" aria-label="4개 중 2번째 항목">
														<a
															...
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																<div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000011.JPG"/>
																</div>
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: http://192.168.10.147/HCYHotel/common/business/img/D000011.JPG"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
													...
													<div role="group" aria-label="4개 중 3번째 항목">
														<a
															...
															class="FNY6 FNY6-pres-quarter FNY6-mod-variant-default FNY6-mod-fluid-stretch FNY6-mod-center FNY6-mod-shape-round FNY6-mod-transition-none"><div
																role="figure" class="FNY6-image-container">
																<div>
																<img src="http://192.168.10.147/HCYHotel/common/business/img/D000006.JPG"/>
																</div>
																<div
																	class="ATNn FNY6-image FNY6-mod-image-position-center"
																	aria-label="스위트 호텔 경주"
																	style="background-image: http://192.168.10.147/HCYHotel/common/business/img/D000006.JPG"></div>
																<div class="FNY6-label-container"></div>
															</div>
															<div
																class="FNY6-content FNY6-mod-content-background-default">
						...
						<section class="bDbo bDbo-spacing-bottom"
							...
							<div class="kml-layout edges-s snap">
								<header class="KzeV">
									<div class="KzeV-header">
										<div class="KzeV-info">
											<div class="KzeV-title">인기 다이닝 리스트</div>
