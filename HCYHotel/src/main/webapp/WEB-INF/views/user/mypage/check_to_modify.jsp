...
<html lang="ko">
<head>
<title>회원정보 수정 - 마이페이지 | HCYCombined</title>
		...
		<div id="sri_wrap">
			<div id="content">
				<div class="wrap_title_recruit">
					<h1 class="title_common">비밀번호 확인</h1>
				</div>
				<div class="help_find" id="person_find">
					...
					<div class="cont_find">
						<form
							...
							<fieldset>
								<legend class="blind">개인회원 입력 폼</legend>
								<ul class="list_find">
									<li>
										<div class="wrap_lab">
									...
									<li>
										<div class="wrap_lab">
											<label for="password" class="lab_find">비밀번호 재입력</label>
										</div>
										<div class="wrap_input">
											<span class="box_input"> <input type="text"
