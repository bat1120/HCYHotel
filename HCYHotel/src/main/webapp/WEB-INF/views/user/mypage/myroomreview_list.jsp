...
<title>나의 호텔 후기 - 마이페이지 | HCYCombined</title>
...
<div >
<h3 class="content-main-title" style="margin-top:7%; ">나의 호텔 후기</h3>
...
<tr style="font-family: ; color: ; ">
	<td colspan="3" style="width: 400px;"><strong>객실 </strong><%-- <c:out value="${ diningReviewList.diningName }" /> --%></td>
