						...
						<fieldset>
							...
							<div class="cont_division">
								<div class="write_base">
									...
									<!-- 생년월일 -->
									<div class="item">
										<label for="birth_date"><strong>사업자 번호</strong></label>
										<div class="TypoBox">
											<input type="number" name="tmp_birth_date" id="birth_date"
												maxlength="8" autocapitalize="off" placeholder="000-00-00000"
												class="Typo SizeL defalt">
										</div>
										<em class="msgInvalid" id="cyr_msg" style="display: none">
											<span>000-00-00000 입력 형식을 확인해주세요.</span>
										</em>
