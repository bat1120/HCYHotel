						...
						<fieldset>
							...
							<div class="cont_division">
								<div class="write_base"> 
									...
									<!-- 사업자 번호 -->
									<div class="item">
										<label for="identifier"><strong>사업자 번호</strong></label>
										<div class="TypoBox">
											<input type="text" name="identifier" id="identifier"
												maxlength="15" autocapitalize="off" placeholder="000-00-00000"
												class="Typo SizeL defalt">
										</div>
										<em class="msgInvalid" id="cyr_msg" style="display: none">
											<span>사업자 번호를 올바르게 입력해주세요</span>
										</em>
