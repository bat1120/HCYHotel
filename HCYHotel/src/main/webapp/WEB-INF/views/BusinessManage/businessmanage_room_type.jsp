...
<div style="display: flex; flex-direction: column; align-items: center;">
						<form id="frm" action="businessmanage_room_type_insert.do" method="get">
    ...
    <input type="hidden" value="${hotelcode}" id="hotelcode" name="hotelcode">;
        <input type="button" value="객실타입 등록" class="btn btn-info btn-sm" id="newRoomTypeBtn" name="newRoomTypeBtn">
    </div>
    </form>
    <div style="display: flex; justify-content: center; align-items: center;">
        <table style="width: 900px; border: 1px solid black;">
            ...
            <c:forEach var="typelist" items="${typelist}" varStatus="i">
                <tr>
                    <th><c:out value="${typelist.typename}" /></th>
                    <th><c:out value="${typelist.price}" /></th>
                    <th><c:out value="${typelist.basiccapacity}" /> / <c:out value="${typelist.maxcapacity}" /></th>
                    <th>
                        <a href="businessRoomType_info.do?typecode=${typelist.typecode}">수정</a>
                    </th>
                </tr>
            </c:forEach>
        </table>
