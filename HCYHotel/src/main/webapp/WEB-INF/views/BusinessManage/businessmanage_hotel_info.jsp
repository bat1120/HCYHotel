...
<form id="frm" action="businessHotelModify_update.do" enctype="multipart/form-data" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text" id="hotelname" name="hotelname" class="form-control" value="${hotelname}">
    </div>
    <div class="mb-3">
      <label for="disabledTextInput" class="form-label">호텔주소</label>
				...
				<input type="text" class="form-control" id="sample6_address" name="sample6_address" value="${hoteladdr }"><br/>
...
<script>
    ...
    function deleted(){
    	alert(hotelcode);
    	location.href="delete_hotel.do?hotelcode="+hotelcode;
    }
</script>
    </div>
    <div class="mb-3">
 ...
 <option value="5" ${hotelrate eq 5 ? 'selected="selected"' : ''}>5</option>
    ...
    <div class="mb-3">
      ...
      <input type="text" id="description" name="description" class="form-control" value="${hoteldes }">
    </div>
    <div class="mb-3">
...
<img src="http://192.168.10.147/HCYHotel/common/business/img/${filelist.filename }.jpg" class="img-thumbnail" alt="..." style="width:100px;height:100px">
</c:forEach>
    </div>
    <button type="button" class="btn btn-primary" id="save" onclick="test()">저장</button>
    <button type="button" class="btn btn-primary" id="delete" onclick="deleted()">삭제</button>
</form>
